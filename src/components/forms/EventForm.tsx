        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex gap-6 flex-col">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormDescription>
                                The name users will see when booking event
                            </FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <div className="flex gap-2 justify-end">
                                ...
                                <AlertDialogFooter>
                                    ...
                                    <AlertDialogAction
                                        ...
                                        onClick={() => startDeleteTransition(async () => {
                                            ...
                                            if (data?.error) {
                                                form.setError("root", {
                                                    message: "There was an error occured while deleting this event. Please try again."
                                                })
                                            }
                                        })}
                    ...
                    <Button asChild variant="outline" disabled={isDeletePending || form.formState.isSubmitting}>
